...
TARGET_SESSION = os.environ.get("TARGET_SESSION_ID", "session_1")
...
exp:
  ...
  save_dir: {REPO_ROOT}/outputs/Chewie_CO_2016/Stage2_MMD/results_use_pnba_read_adapter_without_reset/{PAIR_TAG}/model/
  loss_dir: {REPO_ROOT}/outputs/Chewie_CO_2016/Stage2_MMD/results_use_pnba_read_adapter_without_reset/{PAIR_TAG}/loss/
  eval_dir: {REPO_ROOT}/outputs/Chewie_CO_2016/Stage2_MMD/results_use_pnba_read_adapter_without_reset/{PAIR_TAG}/eval/
"""
...
def run_target_adaptation_conditional_mmd(cfg, target_session_id, source_session_id):
    ...
    if "dataset" in stage1_cfg and "datapath_root" in stage1_cfg.dataset:
        cfg.dataset.datapath_root = stage1_cfg.dataset.datapath_root
    ...
    if cfg.adapt.get("reset_target_read_adapter", False):
        reset_modules = reset_target_read_adapter(target_ae, target_session_id)
