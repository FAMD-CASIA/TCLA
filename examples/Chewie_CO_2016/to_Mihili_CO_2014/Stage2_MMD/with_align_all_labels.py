...
DEFAULT_CONFIG_PATH = os.path.join(REPO_ROOT, "config", "chewie_to_mihili_cross_subject.yaml")
...
TARGET_MODEL_SESSION = os.environ.get(
    "TARGET_MODEL_SESSION_ID",
    f"{example_config.experiment.target_dataset}_{TARGET_SESSION}",
)
...
cfg = OmegaConf.create(
    {
        ...
        "dataset": {
            "source_datapath_root": os.path.join(REPO_ROOT, "data", example_config.experiment.source_dataset),
            "target_datapath_root": os.path.join(REPO_ROOT, "data", example_config.experiment.target_dataset),
        ...
        "exp": {
            ...
            "save_dir": os.path.join(
                ...
                "outputs",
                example_config.experiment.source_dataset,
                f"to_{example_config.experiment.target_dataset}",
                "Stage2_MMD",
